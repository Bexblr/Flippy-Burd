...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'FLIP.data';
    var REMOTE_PACKAGE_BASE = 'FLIP.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2520563;
      var PACKAGE_UUID = '2916dcf7-4a5e-4f13-b85c-bb7ad75392a6';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 147007, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(147007, 147026, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(147026, 147186, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(147186, 1617966, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1617966, 2492938, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2492938, 2520563, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_FLIP.data');

    };
    Module['addRunDependency']('datafile_FLIP.data');
